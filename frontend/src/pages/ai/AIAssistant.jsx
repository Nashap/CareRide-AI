...
import {
  Bot,
  Send,
  User,import { useState, useRef, useEffect } from "react";
import { motion } from "framer-motion";
import {
  Bot,
  Send,
...
export default function AIAssistant() {
  ...
  const handleSendMessage = async (e) => {
    ...
    const routingInstruction = "[Please reply naturally in the exact same language as my prompt. If it's Manglish, reply in Manglish.] \n\n";
