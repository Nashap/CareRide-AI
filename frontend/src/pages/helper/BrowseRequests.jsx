...
import { Calendar, MapPin, Activity, Search, ShieldCheck } from "lucide-react";
...
export default function BrowseRequests() {
  ...
  const handleAcceptRide = async (rideId) => {
    ...
    try {
      await acceptHelper(rideId, helperProfile.id, "Accepted by helper directly via Browse Requests");
      navigate("/helper/assigned-rides");
    } catch (err) {
