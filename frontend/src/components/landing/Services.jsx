...
function Services() {
  ...
  return (
    <section
      id="services"
      ref={sectionRef}
      className="py-16 md:py-24 bg-cr-bg relative overflow-hidden"
    >
      <motion.div
        initial="hidden"
        whileInView="visible"
      ...
      >
        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-[60%_40%] gap-12 lg:gap-16 items-center">
          ...
          <motion.div
            ...
            className="relative w-full h-[450px] sm:h-[400px] lg:h-[550px] flex items-center justify-center lg:justify-start lg:pl-10 perspective-[1200px]"
          >
            ...
            >
              {services.map((service, index) => {
                ...
                const mobileX = offset === 0 ? "0%" : offset === 1 ? "110%" : offset === services.length - 1 ? "-110%" : "200%";
                const mobileScale = offset === 0 ? 1 : 0.85;
                const mobileOpacity = offset === 0 ? 1 : 0.4;
                const mobileZIndex = offset === 0 ? 30 : 20;
